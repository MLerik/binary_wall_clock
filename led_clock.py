...
class LedClock():
    ...
    def init_pins(self, h_p, m_p, s_p):
        """
        Initiate pins on raspberry for IO communication
        :param h_p:
        :param m_p:
        :param s_p:
        :return:
    ...
    def _update_time(self):
        """
        Updates the time of the Binary Clock
    ...
    def display_time(self, display='LEDScreen'):
        """
        Displays the current time as binary values on the defined display

        :param display: parameter to set the desired display.
        :return:
        """
        self.bin_time = self._update_time()
